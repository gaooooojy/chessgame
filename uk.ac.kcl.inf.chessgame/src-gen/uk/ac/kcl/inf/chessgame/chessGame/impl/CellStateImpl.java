 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.chessgame.chessGame.impl.CellStateImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.chessgame.chessGame.impl.CellStateImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.chessgame.chessGame.impl.CellStateImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CellStateImpl extends MinimalEObjectImpl.Container implements CellState
{
  ...
  {
    return ChessGamePackage.Literals.CELL_STATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChessGamePackage.CELL_STATE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetDisplay(CellDisplaySpec newDisplay, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ChessGamePackage.CELL_STATE__DISPLAY, oldDisplay, newDisplay);
  ...
  public void setDisplay(CellDisplaySpec newDisplay)
  {
    if (newDisplay != display)
    {
      ...
      if (display != null)
        msgs = ((InternalEObject)display).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ChessGamePackage.CELL_STATE__DISPLAY, null, msgs);
      if (newDisplay != null)
        msgs = ((InternalEObject)newDisplay).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ChessGamePackage.CELL_STATE__DISPLAY, null, msgs);
      msgs = basicSetDisplay(newDisplay, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChessGamePackage.CELL_STATE__DISPLAY, newDisplay, newDisplay));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ChessGamePackage.CELL_STATE__NAME:
        return getName();
      case ChessGamePackage.CELL_STATE__DISPLAY:
        return getDisplay();
      case ChessGamePackage.CELL_STATE__TRANSITIONS:
