...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>State Check</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.chessgame.chessGame.impl.StateCheckImpl#getCell_state <em>Cell state</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateCheckImpl extends MinimalEObjectImpl.Container implements StateCheck
{
  /**
  ...
  {
    return ChessGamePackage.Literals.STATE_CHECK;
  }
    ...
    if (cell_state != null && cell_state.eIsProxy())
    {
      ...
      if (cell_state != oldCell_state)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChessGamePackage.STATE_CHECK__CELL_STATE, oldCell_state, cell_state));
      }
    }
    return cell_state;
  }
  ...
  public void setCell_state(CellState newCell_state)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChessGamePackage.STATE_CHECK__CELL_STATE, oldCell_state, cell_state));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ChessGamePackage.STATE_CHECK__CELL_STATE:
